      ...
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4 max-w-lg mx-auto mb-12">
          <div className="fade-in p-6 rounded-xl border border-border bg-surface text-center hover:bg-surface-hover transition-colors">
            <div className="w-10 h-10 mx-auto mb-4 rounded-lg bg-accent/10 flex items-center justify-center">
          ...
          <div className="fade-in p-6 rounded-xl border border-border bg-surface text-center hover:bg-surface-hover transition-colors">
            <div className="w-10 h-10 mx-auto mb-4 rounded-lg bg-purple-100 dark:bg-purple-500/10 flex items-center justify-center">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={i} className="flex gap-3 items-start">
                <span className="w-5 h-5 rounded-full bg-surface-hover border border-border flex items-center justify-center text-[11px] font-medium text-fg-muted flex-shrink-0 mt-0.5">
                  {i + 1}
                </span>
