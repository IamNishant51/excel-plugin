...
const urlProd = "https://[YOUR_HTTPS_DOMAIN]/"; // ⚠️ REPLACE THIS with your actual production URL (e.g. Netlify/Vercel URL)
  ...
  const config = {
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        template: "./src/word-taskpane/taskpane.html",
        chunks: ["polyfill", "word-taskpane"],
      }),
      new HtmlWebpackPlugin({
